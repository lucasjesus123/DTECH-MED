...
/**
 * O "G" do Google, nas quatro cores.
 *
 * Como o do WhatsApp, é marca registrada e vai fiel ao original — inclusive as
 * cores fixas, que por isso NÃO herdam `currentColor`. Ele está aqui para uma
 * coisa só: dizer de onde vêm as avaliações. Nota de cinco estrelas sem a
 * fonte à vista é nota que qualquer um escreve no próprio site.
 */
export function IconeGoogle({ className }: Props) {
  return (
    <svg
      width={24}
      height={24}
